...
class Image
{
    ...
    public function getTagAttributes(): object
    {
        ...
        if ($this->attributes->width < $tag_height) {
            $this->attributes->width = $tag_width;
            $this->attributes->height = floor($this->attributes->height * ($tag_width / $this->attributes->width));
        }
        if ($this->attributes->height < $tag_height) {
            $this->attributes->height = $tag_height;
            $this->attributes->width = floor($this->attributes->width * ($tag_height / $this->attributes->height));
        }
