<?php
// DEBUG: Feeds/Tmpl/defaultfiltertemplate.php loaded

namespace Joomla\Component\Rssfactory\Administrator\View\Feeds\Tmpl;

echo '<!-- DEBUG: Feeds/Tmpl/defaultfiltertemplate.php loaded -->';
...
?>
<form action="<?php echo Route::_('index.php?option=com_rssfactory&view=feeds'); ?>" method="post" name="adminForm" id="adminForm" class="mb-3">
...
<div class="filter-search">
    ...
    <?php echo $this->filterForm->renderField('category_id'); ?>
