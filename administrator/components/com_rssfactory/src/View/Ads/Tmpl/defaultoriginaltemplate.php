...
<div class="ad-original-content">
    <?php
    if (isset($this->item) && isset($this->item->original_content)) {
        echo $this->item->original_content;
    } elseif (isset($this->original_content)) {
        echo $this->original_content;
    } else {
        echo '<div class="alert alert-info">' . Text::_('COM_RSSFACTORY_NO_ORIGINAL_CONTENT') . '</div>';
    }
    ?>
</div>
