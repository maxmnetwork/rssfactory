...
/**
 * Comment Raw Controller class
 *
 * This controller handles raw comment data, extending Joomla's FormController.
 *
 * @since  4.0.0
 */
class CommentRawController extends FormController
{
    /**
